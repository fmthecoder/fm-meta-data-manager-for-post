...
Manage and edit post meta data directly from the WordPress post edit screen — view, add, update, or delete meta fields instantly using AJAX without page reload.
